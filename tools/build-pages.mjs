...
await writeFile(path.join(outputRoot, '_headers'), `/*
  ...
  Content-Security-Policy: default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'none'; form-action 'self'; script-src 'self' 'unsafe-inline' https://www.gstatic.com https://cdn.jsdelivr.net https://accounts.google.com; connect-src 'self' https://*.googleapis.com https://accounts.google.com https://capital-mastery-api.avadhanula-shriyan.workers.dev; img-src 'self' data: blob: https://quickchart.io; style-src 'self' 'unsafe-inline'; font-src 'self' data:; frame-src https://accounts.google.com https://capital-mastery26.firebaseapp.com; upgrade-insecure-requests

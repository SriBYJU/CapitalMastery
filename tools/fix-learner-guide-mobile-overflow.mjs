...
`.cm-learner-guide-shell{width:100%}\n`+
`.cm-learner-guide-nav,.cm-learner-guide-panels,.cm-learner-guide-panel{width:100%;justify-self:stretch}\n`+
`.cm-learner-guide-panels{contain:inline-size}\n`+
`.cm-learner-guide-nav{contain:inline-size}\n`+
`.cm-learner-guide-panel{overflow:hidden}\n`+
`.cm-learner-guide-nav button{min-width:0;max-width:100%;width:100%;grid-template-columns:38px minmax(0,1fr)}\n`+
`.cm-learner-guide-nav button div,.cm-learner-guide-nav button b,.cm-learner-guide-nav button small{min-width:0;max-width:100%;overflow-wrap:anywhere}\n`+
...
`  .cm-learner-guide-hero>.container,.cm-learner-guide-shell{grid-template-columns:minmax(0,100%);width:100%;max-width:100%}\n`+
`  .cm-learner-guide-nav{grid-template-columns:repeat(2,minmax(0,1fr))}\n`+
`  .cm-learner-guide-shell>.cm-learner-guide-nav,.cm-learner-guide-shell>.cm-learner-guide-panels{min-width:0;width:100%;max-width:100%}\n`+
`}\n`+
`@media(max-width:640px){\n`+
`  .cm-learner-guide-nav{grid-template-columns:minmax(0,100%)}\n`+
...
const oldVersions=['learner-guide.css?v=20260830-guided2','learner-guide.css?v=20260830-stability3','learner-guide.css?v=20260830-stability4'];
const newVersion='learner-guide.css?v=20260830-stability5';
let replaced=false;
...
console.log('Learner Guide mobile grid shrink fix applied.');

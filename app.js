(() => {
  ...
  function footer(){
    return `<footer class="footer"><div class="container"><div class="footer-grid">
      ...
      <div><h4>Learn</h4>${link('careers','Careers')}${link('passport','My Learning')}${link('credentials','Credentials')}${link('academy','Academies')}</div>

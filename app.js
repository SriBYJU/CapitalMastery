(() => {
  ...
  function home(){
    ...
    render(`
      ...
      <section class="section cm-press-section" aria-labelledby="cm-press-title"><div class="container cm-press-shell"><header class="cm-press-heading"><div><div class="eyebrow">INTERNATIONAL PRESS</div><h2 id="cm-press-title">As featured on:</h2></div><p>Coverage of the student-built technology portfolio behind Capital Mastery.</p></header><div class="cm-press-grid"><a class="cm-press-card" href="https://ghananews.org/shriyan-avadhanula-16-year-old-technology-innovator/" target="_blank" rel="noopener noreferrer" aria-label="Read the Ghana News article about Shriyan Avadhanula"><span class="cm-press-logo"><img src="assets/press/ghana-news.jpeg" width="2048" height="2048" alt="Ghana News" loading="lazy" decoding="async"></span><span class="cm-press-copy"><strong>Ghana News</strong><span>Read the article <b aria-hidden="true">↗</b></span></span></a><a class="cm-press-card" href="https://ghanamedia.net/shriyan-avadhanula-16-year-old-innovator-platforms/" target="_blank" rel="noopener noreferrer" aria-label="Read the Ghana Media article about Shriyan Avadhanula"><span class="cm-press-logo"><img src="assets/press/ghana-media.jpeg" width="2048" height="2048" alt="Ghana Media" loading="lazy" decoding="async"></span><span class="cm-press-copy"><strong>Ghana Media</strong><span>Read the article <b aria-hidden="true">↗</b></span></span></a></div></div></section>
  ...
  function learnPage(c,n){
    ...
    const assessmentLabel=assessmentFailed?`Retry required · ${assessmentScore}% · 80% needed`:(n===5?'Take simulation knowledge check':'Take 10-question assessment');
    const assessmentActions=assessmentPassed
      ? `<a class="btn btn-gold" data-cm-passed-assessment="true" data-cm-best-score="${assessmentScore}" href="#/${assessmentContinuePath(c,n,false)}">Continue — assessment already passed · ${assessmentScore}% →</a><a class="btn btn-soft" data-cm-review-passed="true" data-cm-release-review="true" href="#/${assessmentReviewPath(c,n,false)}">${n===5?'Review passed knowledge check':'Review passed assessment'}</a>`
      : learningComplete
        ? `<a class="btn btn-primary" href="#/quiz/${c.id}/${n}">${assessmentLabel} →</a>`
        : `<span class="btn btn-soft cm-disabled-action" aria-disabled="true">Complete learning to unlock assessment</span>`;

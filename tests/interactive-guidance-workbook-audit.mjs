...
ok(index.includes('learner-guide.css?v=20260830-stability3')&&index.includes('learner-guide.js?v=20260830-guided1'),'Interactive learner guide assets must be loaded with the current mobile-stability stylesheet generation');
...
ok(guideCss.includes('Failure-seeking mobile containment')&&guideCss.includes('.cm-learner-guide-shell,.cm-learner-guide-panel,.cm-guide-workbook')&&guideCss.includes('overscroll-behavior-inline:contain'),'Learner guide must explicitly contain wide workbook content on narrow screens');
...
console.log('INTERACTIVE GUIDANCE + WORKBOOK AUDIT PASS: learner/employer tours, immediate concept practice, spreadsheet conventions and mobile-contained automatic formulas');

...
ok(index.includes('learner-guide.css?v=20260830-stability5')&&index.includes('learner-guide.js?v=20260830-guided1'),'Interactive learner guide assets must be loaded with the current mobile-stability stylesheet generation');
...
ok(guideCss.includes('Failure-seeking mobile containment')&&guideCss.includes('.cm-learner-guide-nav,.cm-learner-guide-panels')&&guideCss.includes('grid-template-columns:minmax(0,100%)')&&guideCss.includes('contain:inline-size')&&guideCss.includes('overscroll-behavior-inline:contain'),'Learner guide must force grid tracks to shrink while containing only intentionally wide workbook content');
...
console.log('INTERACTIVE GUIDANCE + WORKBOOK AUDIT PASS: learner/employer tours, immediate concept practice, spreadsheet conventions and forced-shrink mobile grids');

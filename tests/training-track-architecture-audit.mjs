...
must(js.includes("route==='simulation'"), 'Professional Readiness must not silently run the shorter Career Skills capstone');
must(js.includes('advancedRouteCareer'), 'Advanced Role Lab/final route guard missing');
...
must(js.includes('data-cm-track-credential-model'), 'Credentials page must explain the two-track credential model');
must(js.includes('data-cm-track-sequence'), 'Career page must show the explicit selected-program sequence');
...
must(css.includes('.cm-track-sequence'), 'Selected-program sequence styling missing');

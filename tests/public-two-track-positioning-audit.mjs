...
must(js.includes('3 verified + completion certificate'), 'Career Skills public credential/completion distinction missing');
...
must(js.includes('completion certificate is not a sixth Standard 2.0 credential'), 'Public comparison must preserve the five-level Standard 2.0 boundary');

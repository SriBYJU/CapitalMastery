...
ok(config.main === 'v2/platform-admin-overlay.js', 'Recovery record must identify the deployable Worker entrypoint');
ok(recovery.includes('v2/platform-admin-overlay.js') && recovery.includes('v2/worker-v2-phase1-release.js'), 'Recovery runbook must document the overlay and core Worker relationship');

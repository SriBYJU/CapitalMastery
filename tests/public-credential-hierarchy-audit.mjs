...
must(js.includes("const isProgramCompletion = c.recordType === 'program_completion' || levelKey === 'career';"), 'Career Skills completion must use explicit program-completion record typing with legacy level fallback');

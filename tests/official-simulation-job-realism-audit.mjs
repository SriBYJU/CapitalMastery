...
const hasHelperPart5Route=app.includes("if(track==='career-skills') return `official-simulation/${c.id}`;") && app.includes('return `role-lab/${roleLabId}`;') && app.includes('function assessmentContinuePath');

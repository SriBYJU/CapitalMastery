...
must(liveAudit.includes('GitHub Pages nineteen-suite live browser matrix: PASS') && liveAudit.includes('tests/accessibility-keyboard-browser-audit.cjs'),'Primary live audit must execute the complete 19-suite matrix including keyboard accessibility');

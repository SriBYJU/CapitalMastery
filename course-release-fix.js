(() => {
  ...
  function ibAdminWorkbench() {
    return `<section class="cm-wb-shell cm-admin-workbench-preview" data-cm-admin-workbench="1">
      ...
      <div class="container cm-wb-layout">
        <aside class="cm-wb-sidebar"><div class="cm-wb-case-card"><span>CLIENT</span><strong>Northstar Holdings</strong><span>TARGET</span><strong>Orion Systems</strong></div><nav><a href="#cm-wb-inbox">01 · Inbox</a><a href="#cm-wb-data">02 · Data Room</a><a href="#cm-wb-model">03 · Transaction Model</a><a href="#cm-wb-valuation">04 · Trading Comps</a><a href="#cm-wb-precedents">05 · Precedents</a><a href="#cm-wb-dcf">06 · DCF</a><a href="#cm-wb-update">07 · Management Update</a><a href="#cm-wb-qa">08 · Model QA</a><a href="#cm-wb-client">09 · Client Takeaway</a><a href="#cm-wb-email">10 · Associate Email</a></nav><div class="cm-security-note"><strong>Admin-only preview.</strong><br>No official score, D1 progress, or credential is written.</div><a class="btn btn-outline btn-block" href="#/admin-preview">Exit Workbench</a></aside>
        <main class="cm-wb-main">
